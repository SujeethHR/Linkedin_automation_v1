...
- **Flask app** — the backend: API routes and local JSON storage.
- **Abacus.AI** — drafts and rewrites post text.
- **LinkedIn API** — publishing and image uploads.
...
A summary shows how many posts are approved and rejected. Click "Publish all approved posts" to send them to LinkedIn immediately.
